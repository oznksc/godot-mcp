...
export function registerUiTools(server, bridge) {
    server.tool('ui_create_control', 'Create a Control node for UI', {
    ...
    server.tool('ui_create_container', 'Create a container node for UI layout', {
    ...
    server.tool('ui_set_anchors', 'Set anchor and margin preset for a Control node', {
    ...
    server.tool('ui_set_theme', 'Set a theme resource on a Control node', {
        path: z.string().describe('Control node path'),
