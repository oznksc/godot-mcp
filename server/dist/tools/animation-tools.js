...
export function registerAnimationTools(server, bridge) {
    server.tool('animation_create', 'Create a new animation on an AnimationPlayer node', {
    ...
    server.tool('animation_list_keys', 'List all keyframes in an animation', {
        node_path: z.string().describe('AnimationPlayer node path'),
        anim_name: z.string().describe('Animation name'),
    ...
    server.tool('animation_add_keyframe', 'Add a keyframe to an animation track', {
        node_path: z.string().describe('AnimationPlayer node path'),
        anim_name: z.string().describe('Animation name'),
    ...
    server.tool('animation_remove_keyframe', 'Remove a keyframe from an animation track', {
        node_path: z.string().describe('AnimationPlayer node path'),
        anim_name: z.string().describe('Animation name'),
    ...
    server.tool('animation_set_length', 'Set the duration of an animation', {
        node_path: z.string().describe('AnimationPlayer node path'),
        anim_name: z.string().describe('Animation name'),
    ...
    server.tool('animation_get_library', 'Get animation library information from an AnimationPlayer', {
        node_path: z.string().describe('AnimationPlayer node path'),
    }, async ({ node_path }) => {
