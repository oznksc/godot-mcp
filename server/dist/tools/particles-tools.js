...
export function registerParticlesTools(server, bridge) {
    server.tool('particles_create', 'Create a GPU particles node', {
    ...
    server.tool('particles_set_material', 'Set the particle process material', {
    ...
    server.tool('particles_configure', 'Configure particle properties', {
        path: z.string().describe('Particles node path'),
...
//# sourceMappingURL=particles-tools.js.map