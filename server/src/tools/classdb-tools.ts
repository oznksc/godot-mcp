...
export function registerClassdbTools(server: McpServer, bridge: GodotBridge): void {
  server.tool(
    'classdb_query',
    'Query information about a Godot class',
    {
  ...
  server.tool(
    'classdb_list_methods',
    'List methods of a Godot class',
    {
  ...
  server.tool(
    'classdb_list_classes',
    'List all available Godot classes',
    {
