...
export function registerPrompts(server: McpServer): void {
  server.prompt(
    'godot_scene_setup',
    'Guide for setting up a Godot scene with proper hierarchy',
    {
...
Scene type: ${scene_type}`,
  ...
  server.prompt(
    'godot_node_guide',
    'Guide about Godot node types and their usage',
    {
...
Please provide practical examples with GDScript code.`,
  ...
  server.prompt(
    'godot_script_review',
    'Template for reviewing GDScript code',
    {
...
\`\`\``,
  ...
  server.prompt(
    'godot_debug_guide',
    'Debugging guide for Godot issues',
    {
...
5. Recommend relevant Godot documentation`,
  ...
  server.prompt(
    'godot_export_guide',
    'Guide for configuring Godot exports',
    {
